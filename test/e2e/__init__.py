...
SERVICE_NAME = "mwaaserverless"
CRD_GROUP = "mwaaserverless.services.k8s.aws"
...
def load_mwaaserverless_resource(resource_name: str, additional_replacements: Dict[str, Any] = {}):
