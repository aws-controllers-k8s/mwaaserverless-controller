...
import (
	...
	svctypes "github.com/aws-controllers-k8s/mwaaserverless-controller/apis/v1alpha1"
	svcresource "github.com/aws-controllers-k8s/mwaaserverless-controller/pkg/resource"

	"github.com/aws-controllers-k8s/mwaaserverless-controller/pkg/version"
)

var (
	awsServiceAPIGroup = "mwaaserverless.services.k8s.aws"
	awsServiceAlias    = "mwaaserverless"
